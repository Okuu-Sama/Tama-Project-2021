...
public class Display : MonoBehaviour
{
    ...
    public float spawningLocation = 20.0f;  
    ...
    private readonly NoteType[] typeNote = new NoteType[] { NoteType.simple, NoteType.simple , NoteType.simple , NoteType.simple , NoteType.slider , NoteType.slider , NoteType.simple , NoteType.simple , NoteType.simple , NoteType.simple }; 
    #endregion
    ...
    void Update()
    {
        ...
        while(counter < time.Length && timer >= time[counter])
        {
            ...
            {
                note = Instantiate(SliderPrefab, new Vector3(counter % 2, spawningLocation, 0), Quaternion.identity) as GameObject;
